...
Follow the steps outlined in [the RubyGems and Bundler OpenSSL/TLS guide](/rubygems_tls_ssl_troubleshooting_guide#troubleshooting-certificate-errors) to troubleshoot the problem.
