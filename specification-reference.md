...
for a list of licenses and their abbreviations (or short names).  GitHub also provides a [license picker](http://choosealicense.com/).</p>

<p>According to copyright law, not having an OSI-approved open source license means you have no rights to use the code for any purpose – in other words, ["all rights reserved"](https://www.infoworld.com/d/open-source-software/github-needs-take-open-source-seriously-208046).</p>
